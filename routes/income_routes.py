...
# @income_bp.route('/api/expenses', methods=['GET'])
# def get_expenses():
...
# @income_bp.route('/api/expenses', methods=['POST'])
# def add_expense():
#     if 'user' not in session:
#         return jsonify({'error': 'Not authenticated'}), 401
...
# @income_bp.route('/api/expenses/bulk', methods=['POST'])
...
# @income_bp.route('/api/expenses/delete', methods=['POST'])
# def delete_expense():
#     if 'user' not in session:
#         return jsonify({'error': 'Not authenticated'}), 401
...
# @income_bp.route('/api/expenses/bulk-delete', methods=['POST'])
